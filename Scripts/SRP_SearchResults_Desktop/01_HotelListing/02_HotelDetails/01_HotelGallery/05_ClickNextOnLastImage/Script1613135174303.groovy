...
WebUI.setText(findTestObject('SharedComponent/SSB/Location'), 'ferrereta')
...
int total = WebUI.getText(findTestObject('PageSpecific/ExploreHotels/HotelItem/Gallery/NavNumbers/Total')).toInteger()
int i = 1
while (i < total) {
