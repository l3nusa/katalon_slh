...
WebUI.scrollToElement(findTestObject('PageSpecific/ExploreHotels/HotelItem/Gallery/Image'), 0)
WebUI.click(findTestObject('PageSpecific/ExploreHotels/HotelItem/Gallery/Image'))
