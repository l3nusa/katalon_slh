...
String actDescription = WebUI.getText(findTestObject('PageSpecific/ExploreHotels/HotelItem/HotelBox/Description'))

WebUI.verifyMatch(actDescription, description, true, FailureHandling.STOP_ON_FAILURE)
