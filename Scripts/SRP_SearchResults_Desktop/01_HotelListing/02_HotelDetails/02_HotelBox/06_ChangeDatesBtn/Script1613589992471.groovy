...
for (int i = 0 ; i < stayingPeriod ; i++) {
	WebUI.click(findTestObject('SharedComponent/SSB/DatePicker/RightBtn'))
}

def checkout
use(TimeCategory){
	checkout = checkin + stayingPeriod.months
}
...
CustomKeywords.'customPackage.ssb.setAdultsAmount'(GlobalVariable.SSB_GuestsAmount)
