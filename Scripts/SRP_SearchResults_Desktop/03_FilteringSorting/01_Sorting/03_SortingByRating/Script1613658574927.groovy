...
WebUI.click(findTestObject('PageSpecific/ExploreHotels/Header/SortingOptions/ByRating'))

sleep(100)
String rating = WebUI.getText(findTestObject('PageSpecific/ExploreHotels/HotelItem/HotelBox/Rating'))
WebUI.verifyMatch(rating, expRating, true, FailureHandling.STOP_ON_FAILURE)
