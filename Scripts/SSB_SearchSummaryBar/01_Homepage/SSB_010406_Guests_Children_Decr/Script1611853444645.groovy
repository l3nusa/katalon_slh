...
CustomKeywords.'customPackage.ssb.setChildrenAmount'(2)
...
WebUI.verifyElementText(findTestObject('SearchSummaryBar/Guests'), (GlobalVariable.SSB_GuestsTextTextAmount ) + GlobalVariable.SSB_GuestsTextTextText)
