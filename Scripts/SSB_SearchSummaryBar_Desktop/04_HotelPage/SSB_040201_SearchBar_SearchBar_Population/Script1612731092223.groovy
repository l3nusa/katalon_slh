...
WebUI.click(findTestObject('PageSpecific/HotelPage/SecondaryNav/EditBtn'))

WebUI.verifyElementText(findTestObject('PageSpecific/HotelPage/SecondaryNav/SSB/Checkin'), checkin.format('d MMMM'))
WebUI.verifyElementText(findTestObject('PageSpecific/HotelPage/SecondaryNav/SSB/Checkout'), checkout.format('d MMMM'))
WebUI.verifyElementText(findTestObject('PageSpecific/HotelPage/SecondaryNav/SSB/Guests'), (GlobalVariable.SSB_AdultsMin + children) + GlobalVariable.SSB_GuestsText)
